...
@pytest.mark.asyncio
async def test_provider_crud_never_returns_plain_api_key(logged_in_client: AsyncClient) -> None:
    ac = logged_in_client
...
@pytest.mark.asyncio
async def test_model_default_is_exclusive_and_agent_binding_updates_model_id(
...
@pytest.mark.asyncio
async def test_delete_model_unbinds_agents_to_default_fallback(
    logged_in_client: AsyncClient,
) -> None:
    ac = logged_in_client
    provider = await _create_provider(ac)
...
@pytest.mark.asyncio
async def test_resolve_llm_env_prefers_agent_model_then_default(
    logged_in_client: AsyncClient,
) -> None:
    ac = logged_in_client
    provider = await _create_provider(ac)
